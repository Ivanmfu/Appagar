    ...
    return (
      <main className="p-6 max-w-md mx-auto mt-12 space-y-4 text-center">
        ...
        <p className="text-gray-600">
          Hemos enviado {mode === 'signup' ? 'un enlace de confirmación' : 'un enlace mágico'} a <strong>{email}</strong>
        </p>
  ...
  return (
    <main className="p-6 max-w-md mx-auto mt-12 space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-gray-600">
          {mode === 'signup' ? 'Crea tu cuenta para comenzar' : 'Inicia sesión en tu cuenta'}
        </p>
      </div>
      ...
      <div className="space-y-4 bg-white p-6 rounded-lg border shadow-sm">
        ...
        {/* Google Login */}
        <button
          className="w-full flex items-center justify-center gap-3 border border-gray-300 hover:bg-gray-50 px-4 py-3 rounded-md font-medium transition-colors"
        ...
        {mode !== 'magic-link' ? (
          <div className="space-y-4">
            ...
            <button
              ...
              disabled={loading}
            >
              ¿Prefieres un enlace mágico sin contraseña?
            </button>
          </div>
        ) : (
          <div className="space-y-4">
